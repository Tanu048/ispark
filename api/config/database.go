...
func ConnectDB() {
	...
	err = DB.AutoMigrate(&models.Student{}, &models.OTP{}, &models.Admin{}, &models.Activity{}, &models.Certificate{}, &models.Enrollment{}, &models.SystemSetting{}, &models.Track{}, &models.GeneratedReport{}, &models.ScheduledReport{}, &models.ReportAuditLog{})
